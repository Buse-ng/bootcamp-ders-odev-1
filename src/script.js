...
console.log(
  "\nfiyatı 30 ile 100 arasında kaç adet ürün var? : " + countProducts3
);
...
var message = productId
  ? "\nID'si 10 olan ürünün adi: " + productId.name
  : "\nID'si 10 olan ürün bulunamadi.";

console.log(message);

//en pahalı urunun adı
var enPahaliUrun = products.reduce(function (maxProduct, currentProduct) {
  return currentProduct.unitPrice > maxProduct.unitPrice
    ? currentProduct
    : maxProduct;
}, products[0]);
...
//en uygun urunun adı
var enUygunUrun = products.reduce(function (minProduct, currentProduct) {
  return currentProduct.unitPrice < minProduct.unitPrice
    ? currentProduct
    : minProduct;
}, products[0]);
console.log("\nEn uygun ürün: " + enUygunUrun.name);

// İsmi 'a' ile başlayan ürünleri bulma
var aileBaslayanUrunler = products.filter(function (product) {
  return product.name.charAt(0).toLowerCase() === "a";
});

console.log("\nİsmi 'a' ile başlayan ürünler:");
aileBaslayanUrunler.forEach(function (product) {
  console.log(product.name);
});

// İsmi 'a' ile biten ürünleri bulma
var aileBitenUrunler = products.filter(function (product) {
  return product.name.charAt(product.name.length - 1).toLowerCase() === "a";
});

console.log("\nİsmi 'a' ile biten ürünler:");
aileBitenUrunler.forEach(function (product) {
  console.log(product.name);
});
