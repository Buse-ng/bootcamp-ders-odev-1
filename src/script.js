...
// discontinued false olan kaç urun vardır
...
//ürün fiyatı 50 den büyük olan ürünleri console a yaz.
//FILTER

var filteredProducts = products.filter(x => x.unitPrice > 50)
console.log(filteredProducts);


//ismi A harfi ile başlayan ürünleri
var filteredProducts2 = products.filter(x => x.name.startsWith('A'))
console.log(filteredProducts2);

//FIND method
//find syntax filter ile birebir aynıdır. sadece bu fonksiyon YAKALADIĞI İLK değeri yani bir adet object return eder!

var product = products.find(q => q.id == 3333);
console.log(product?.name);

// alert('Hello')

//sort function diziyi sıralamamı sağlar...!
